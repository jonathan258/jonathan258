...
public class CisUtility {
    ...
    /**
     * Get the double formatted for currency.  Functionality taken from the 
     * following url:
     ...
     * @author BJM
     */
    public static String getCurrency(double dollarsDouble) {
        // Create a new Locale
        ...
        return dollarFormat.format(dollarsDouble);
    }
